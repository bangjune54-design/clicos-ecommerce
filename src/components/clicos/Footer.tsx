...
export function Footer() {
  ...
  return (
    <footer className="bg-primary-50 text-gray-800 pt-8 pb-6 relative overflow-hidden border-t border-primary-100">
      ...
      <div className="mx-auto max-w-[1800px] px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 pb-6 border-b border-primary-100">
          ...
          <div className="md:col-span-5">
            <a
              ...
              className="text-xl font-serif font-bold tracking-wider text-primary-800 inline-block mb-2 hover:text-primary-900 transition-colors"
            >
              KOSMERA
            </a>
          ...
          <div className="md:col-span-3 flex flex-col justify-between items-start md:items-end">
            ...
            <button
              onClick={scrollToTop}
              className="mt-4 flex items-center justify-center gap-1.5 text-[10px] font-bold uppercase tracking-widest text-primary-700 hover:text-accent transition-colors focus:outline-none"
            >
              {t("back_to_top")}
        ...
        <div className="pt-4 flex flex-col sm:flex-row items-center justify-between gap-3 text-center sm:text-left text-xs text-gray-500 font-medium">
          <p>
            © 2026 KOSMERA. {t("all_rights_reserved")}
          </p>
          <div className="flex items-center gap-6">
            <span className="hover:text-primary-800 transition-colors cursor-pointer">{t("privacy_policy")}</span>
            <span className="hover:text-primary-800 transition-colors cursor-pointer">{t("terms_of_service")}</span>
          </div>
        </div>
