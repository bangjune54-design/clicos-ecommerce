...
export function BrandGrid() {
  ...
  return (
    <section id="brands" className="py-12 sm:py-16 md:py-20 bg-white">
          ...
          {allDisplayBrands.map((brand, idx) => (
            ...
            >
              <div className="w-full flex flex-col items-center">
                ...
                <div className="w-28 h-20 rounded-2xl flex items-center justify-center mb-4 overflow-hidden border border-gray-100 relative bg-white shadow-sm">
                  {brand.image ? (
                    <img
                      src={brand.image}
                      alt={`${brand.name} logo`}
