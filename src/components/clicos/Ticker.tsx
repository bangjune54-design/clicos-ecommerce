...
export function Ticker({ tickers }: TickerProps) {
  ...
  return (
    <div className="w-full bg-accent text-white py-2.5 sm:py-4.5 overflow-hidden relative shadow-sm border-y border-accent-hover/20 z-20 select-none">
      <div className="flex whitespace-nowrap w-full">
        ...
        <div className="animate-marquee flex shrink-0 items-center gap-12 pl-6 pr-6">
          <span className="text-[10px] sm:text-sm lg:text-base font-bold uppercase tracking-widest font-sans">
            {jointText}
          </span>
        </div>
