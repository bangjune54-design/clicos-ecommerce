 ...
 */
export const sendAdminNotification = (subject: string, details: any, to: string = "info@clicos.co.kr, wholesales@clicos.co.kr") => {
  const emailText = `
=========================================
📧 EMAIL SENT
...
`;
  ...
  toast.innerHTML = `
    <div class="flex items-center justify-between gap-4 border-b border-gray-700 pb-3">
      ...
      <span class="text-[10px] text-gray-400 font-mono tracking-wider max-w-[180px] truncate" title="${to}">${to}</span>
    </div>
