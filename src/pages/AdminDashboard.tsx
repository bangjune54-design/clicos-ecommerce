                ...
                {orders.map((order) => (
                  <tr key={order.id} className="hover:bg-gray-50">
                    ...
                    <td className="whitespace-nowrap px-6 py-4 text-right text-sm font-medium">
                      <button className="text-primary-600 hover:text-primary-900 font-semibold flex items-center gap-1 justify-end w-full">
            ...
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th className="px-6 py-4 text-right text-xs font-semibold text-gray-900 uppercase tracking-wider">Status</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-200 bg-white">
                {mockAccounts.map((acc) => (
                  <tr key={acc.id} className="hover:bg-gray-50">
                    ...
                    <td className="whitespace-nowrap px-6 py-4 text-sm">
                      <Badge variant={acc.type === 'Wholesale' ? 'accent' : acc.type === 'Admin' ? 'secondary' : 'default'} className="uppercase text-[10px]">
                        {acc.type}
                      </Badge>
                    </td>
